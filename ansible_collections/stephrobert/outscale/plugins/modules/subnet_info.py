...
DOCUMENTATION = r"""
module: subnet_info
short_description: Gather information about Outscale subnets
version_added: 0.1.0
description:
- List Outscale subnets, optionally filtered. This module never changes anything.
author:
- Stéphane Robert (@stephrobert)
options:
  filters:
    description: 'One or more filters. Accepted keys: C(AvailableIpsCounts), C(IpRanges),
      C(NetIds), C(States), C(SubnetIds), C(SubregionNames), C(TagKeys), C(TagValues), C(Tags).'
    type: dict
