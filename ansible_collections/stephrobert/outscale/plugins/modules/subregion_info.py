...
# Opérations : ReadSubregions
# Régénérer  : mise run generate

from __future__ import annotations

DOCUMENTATION = r"""
module: subregion_info
short_description: Gather information about Outscale subregions
version_added: 0.1.0
description:
- List Outscale subregions, optionally filtered. This module never changes anything.
author:
- Stéphane Robert (@stephrobert)
options:
  filters:
    description: 'One or more filters. Accepted keys: C(RegionNames), C(States), C(SubregionNames).'
    type: dict
...
MODULE = InfoModule(
    ...
    operation=Operation(
        id="ReadSubregions",
        method="ReadSubregions",
        body_params={"filters": "Filters"},
        payload_field="Subregions",
        is_list=True,
