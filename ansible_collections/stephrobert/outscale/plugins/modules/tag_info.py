...
DOCUMENTATION = r"""
module: tag_info
short_description: Gather information about Outscale tags
version_added: 0.1.0
description:
- List Outscale tags, optionally filtered. This module never changes anything.
author:
- Stéphane Robert (@stephrobert)
options:
  filters:
    description: 'One or more filters. Accepted keys: C(Keys), C(ResourceIds), C(ResourceTypes),
      C(Values).'
    type: dict
