...
deux : le **chemin** (`ansible_collections/stephrobert/outscale`) et
**galaxy.yml**. On ne peut pas en supprimer une, l'outil impose les deux. Ce
qu'on peut faire, et que fait `load_collection`, c'est **exiger qu'elles
concordent**.
"""
