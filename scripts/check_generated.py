...
Le principe : régénérer, puis exiger que git ne voie aucune différence.
`git diff --exit-code` seul ne suffit pas : il ne voit pas un fichier non
suivi, et un module tout neuf, produit et jamais commité, le laisserait vert.
Ce script regarde les deux : ce qui a changé, et ce qui est apparu.
